...
if ( $_SERVER['REQUEST_METHOD'] == 'GET' ) {
  ...
  $sql = "SELECT * FROM brgy_official WHERE id=$id";
  ...
  // update data
    ...
    $sql = "UPDATE brgy_official " .
    "SET name = '$name', position = '$position', birthdate = '$birthdate', gender = '$gender', address = '$address', contact = '$contact' " .
    "WHERE id = $id";
