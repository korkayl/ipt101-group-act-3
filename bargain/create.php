...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
  ...
  $insert_query = "INSERT INTO tb_residents (name, birthdate, gender, address, contact) 
                   VALUES ('$name', '$birthdate', '$gender', '$address', '$contact')";

  if ($connection->query($insert_query) === TRUE) {
    $successMessage = "New resident added successfully";
